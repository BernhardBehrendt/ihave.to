 ...
 */
var Board = function (sBoard, oSocket) {
...
Board.prototype.setBoard = function (sBoardData) {
    ...
    this.__oFs.writeFile(this.sBoardFile, sBoardData, 'UTF-8', function (error) {
 ...
 * @param {String} the verifier SHA-3 checksum
 */
    ...
    this.__oFs.exists(this.sBoardFolder, function (exists) {
        ...
        if (!exists) {
            ...
            oProxBoardObj.__oFs.mkdir(oProxBoardObj.sBoardFolder, 0777, function () {
                // Create verfier file
                oProxBoardObj.__oFs.writeFile(oProxBoardObj.sVerifierFile, verifier, 'UTF-8', function (error) {
